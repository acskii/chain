        ...
        <div className="flex items-center gap-6">
          ...
          {hasChanges && (
            <button 
              onClick={handleSave}
              disabled={isSaving}
              className="flex items-center gap-2 bg-[#1c212c] hover:bg-emerald-600 border border-gray-700 hover:border-emerald-500 px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-[0.1em] transition-all shadow-lg text-gray-300 hover:text-white"
            >
              {isSaving ? (
